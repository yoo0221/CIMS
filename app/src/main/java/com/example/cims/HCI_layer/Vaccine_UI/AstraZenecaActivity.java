...
public class AstraZenecaActivity extends AppCompatActivity {
    ...
    private Button btn_loadse_a;
    private int vac_id = 4;
    private Vaccine astrazeneca;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar)findViewById(R.id.topbar_astrazeneca);
        ...
        FloatingActionButton btn_home = findViewById(R.id.fab_home_astrazeneca);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for(int i = 0;i < jsonArray.length();i++){
                        ...
                        if(i == 0)
                            astrazeneca = new Vaccine(jsonObject.getString("name"),
                        ...
                        astrazeneca.appendSideEffect(sideEffect);
                    }
        ...
        btn_loadse_a = findViewById(R.id.btn_loadse_a);
        btn_loadse_a.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int i = 0;
                listView.setText("No.    부작용 설명\n");
                Iterator<SideEffect> itr = astrazeneca.requestSideInfo().iterator();
                while(itr.hasNext()) {
                    i++;
