...
public class JanssenActivity extends AppCompatActivity {
    private TextView listView;
    private Button btn_loadse_j;
    private int vac_id = 3;
    private Vaccine janssen;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_janssen);

        Toolbar toolbar = (Toolbar)findViewById(R.id.topbar_janssen);
        ...
        FloatingActionButton btn_home = findViewById(R.id.fab_home_janssen);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for(int i = 0;i < jsonArray.length();i++){
                        ...
                        if(i == 0)
                            janssen = new Vaccine(jsonObject.getString("name"),
                        ...
                        janssen.appendSideEffect(sideEffect);
                    }
        ...
        btn_loadse_j = findViewById(R.id.btn_loadse_j);
        btn_loadse_j.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int i = 0;
                listView.setText("No.    부작용 설명\n");
                Iterator<SideEffect> itr = janssen.requestSideInfo().iterator();
                while(itr.hasNext()) {
                    i++;
